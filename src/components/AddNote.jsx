    ...
    <form onSubmit={handleSubmit}>
        <div className='note new'>
            <div className='newNoteContent'>
                <input spellCheck='false' type="text" name='title' onChange={handleChange} placeholder='Note title' value={note.title}/>
                <textarea spellCheck='false' name="content" cols="30" rows="10" onChange={handleChange} placeholder='Note content' value={note.content}></textarea>
            </div>
            <div className="noteFooter">
                <small>{contentLimit - note.content.length} Remaining</small>
                <button type="submit" className='save'><i className="fa-solid fa-plus"></i></button>
            </div>
        </div>
    </form>  
    </>
